...
/**
 * adding_all_mul - fxn that sums all the addition to know
 * the multiplication result
 * @a: number 1
 * @len_a: lenght of number 1
 * @b: number 2
 * @len_b: lenght of number 2
 * Return: Additn pointer to the total result of the multiplcn
 */
...
/**
 * error_message - prints an error message and exit with status 98
 * Return: Nothing
 */
